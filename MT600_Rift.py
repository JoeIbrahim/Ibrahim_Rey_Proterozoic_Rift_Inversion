...
### Run the model. 
# restartStep = -1 to restart from the latest checkpoint. You can also specify a particular checkpoint number. E.g. to restart from checkpoint 10 (1 myrs), use restartStep=10.
Model.run_for(8000001 * u.years, checkpoint_interval=100000. * u.year, restartStep=-1, restartDir="MT600C_Rift_O")
