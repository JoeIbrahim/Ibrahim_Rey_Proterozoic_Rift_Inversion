...
# %%
### Tectonic Quiescence Velocity Boundary Conditions
...
### Run the model. 
# Specify a particular checkpoint number to restart from. E.g. to begin a phase of tectonic quiescence after 8 m.y. of extension, use restartStep=80, comment out the extensional boundary conditions above, and uncomment the quiescence boundary conditions. 
# The restartDir should be the name of the output directory used in the previous run. E.g., to restart from the end of the Rift_600C model, use restartDir="MT600C_Rift_O", to restart this model use the current output directory name "MT600_Qsc_O".
Model.run_for(60000001 * u.years, checkpoint_interval=100000. * u.year, restartStep=-1, restartDir="MT600C_Rift_O")
